...
public:
    ...
    enum class ENUM_SCREEN_EVENT {
        ...
        EVENT_GOTO_COMMAND_TEMPMEASURE,
        EVENT_GOTO_COMMAND_HEIGHTDIAMETTER,
        EVENT_GOTO_COMMAND_WEIGHTDIAMETTER,
        EVENT_GOTO_COMMAND_BLOODPRESSMEASURE
    };
    enum class ENUM_POPUP_EVENT {
        ...
        EVENT_SHOW_POPUP_CONFIRMEXIT,
        EVENT_SHOW_POPUP_NOTCHANGEUSER,
        EVENT_SHOW_POPUP_SAVEDATA,
        EVENT_HIDE_POPUP,
