...
const QMap<int, DEVICESTRUCT> CONST_TABLE_DEVICE {
    {static_cast<int>(HomeScreen_Enum::ENUM_DEVICE::DEVICE_HEIGHT_DIAMETTER),                   {"Height diametter",             "Unknow"}},
    {static_cast<int>(HomeScreen_Enum::ENUM_DEVICE::DEVICE_WEIGHT_DIAMETTER),                   {"Weight diametter",             "Unknow"}},
    {static_cast<int>(HomeScreen_Enum::ENUM_DEVICE::DEVICE_BLOOD_PRESSUSER_DIAMETTER),          {"Blood pressuer diametter",     "Unknow"}},
    {static_cast<int>(HomeScreen_Enum::ENUM_DEVICE::DEVICE_BLOOD_ANALYZER_DIAMETTER),           {"Blood analyser",               "Unknow"}},
    {static_cast<int>(HomeScreen_Enum::ENUM_DEVICE::DEVICE_IMAGE_ANALYZER),                     {"Image analyser",               "Unknow"}}
};
